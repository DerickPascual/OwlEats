...
describe('getMenus tests', () => {
    test('Case with meals, nameless items', async () => {
        const menu = await getMenus(path.join(__dirname, 'mock_pages', 'northMenus_6_13_23.html'));
    ...
    test("Average case with full menus", async () => {
        const menu = await getMenus(path.join(__dirname, 'mock_pages', 'southMenus_6_13_23.html'));
